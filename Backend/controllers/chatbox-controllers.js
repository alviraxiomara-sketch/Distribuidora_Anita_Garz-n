...
export const chatearConDistribuidoraAnita = async (req, res) => {
  try {
    ...
    const systemPrompt = `
Eres el asesor virtual y anfitrion de la Distribuidora "Distribuidora Anita".
...
1. Si el cliente solo saluda (ej: "Hola", "¿Como estas?"), responde con cortesia y cercania sin dar la carta ni precios:
   "¡Hola! Bienvenido a Distribuidora Anita 🥤. Que alegria tenerte aqui, ¿en que antojo refrescante te podemos colaborar hoy?"
